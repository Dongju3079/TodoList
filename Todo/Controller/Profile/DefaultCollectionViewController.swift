...
class DefaultCollectionViewController: UIViewController {
...
extension DefaultCollectionViewController: UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return MyProfilePhoto.photoList.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.categoryText = MyProfilePhoto.photoList[indexPath.item]
